...
const PopupForm = ({ handleClose, show }) => {
    ...
    return (
        ...
        <h1 className="site-logo-popup"> 
                   ...
                   <p className="logoTextFront">Symtomguiden</p>
                </h1></div>
